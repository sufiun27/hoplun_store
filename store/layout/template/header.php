                    ...
                    <div class="sb-sidenav-menu">
                        <div class="nav">
                            ...
                            <div class="collapse" id="collapseLayouts0" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav id="add_customer" class="sb-sidenav-menu-nested nav ">
                                <a id="collapseLayouts0_search" class="nav-link" href="http://<?php echo $_SESSION['base_url'];?>/store/layout/supplier/supplier_search.php">list</a>
...
?>
<a id="collapseLayouts2_list" class="nav-link" href="http://<?php echo $_SESSION['base_url']; ?>/store/layout/purchase_product/purchase_list.php?page=1&section=<?php echo $_SESSION['section']; ?>&startDate=<?php echo $defaultStartDate; ?>&endDate=<?php echo $defaultEndDate; ?>">Purchase List</a>
                            ...
                            <div class="collapse" id="collapseLayouts3" aria-labelledby="headingOne" data-bs-parent="#sidenavAccordion">
                                <nav class="sb-sidenav-menu-nested nav">
                                    <a id="collapseLayouts3_add" class="nav-link" href="http://<?php echo $_SESSION['base_url'];?>/store/layout/issue_item/issue_iteam.php">Issue</a>
