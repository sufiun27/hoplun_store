...
<div id="layoutSidenav_content">
    <main>
        <div class="container-fluid px-4">
            ...
            <h4 class="text-success">Issue Items (materials details) <?php  if($replacement == 1){ echo "REPLACE"; }else{ echo"NEW"; } ?></h4>
            <table>
                <thead>
                <tr>
                    <th>Lot No</th>
            ...
            <?php 
                    if ($replacement == 1) { 
                        // Display an input field for remarks
                        echo '<input type="text" name="reason" placeholder="Reason for replacement">';
                    }
                    ?>
                ...
                <input type="hidden" name="replacement" value="<?php echo htmlspecialchars($replacement); ?>">
